...
BEGIN
  ...
  IF todos_feitos THEN
    ...
    -- When phase 5 (Teste do App) completes, create "Publicar na loja" item in phase 6
  ...
  -- Calculate porcentagem_geral based on ALL checklist items done vs total
  SELECT COUNT(*), COUNT(*) FILTER (WHERE feito = TRUE)
