...
BEGIN
  ...
  -- FASE 0 - Pré-Requisitos (includes mockup/assets request as last sub-step)
  ...
  -- FASE 3 - Criação e Submissão (includes form items first)
  INSERT INTO app_checklist_items (cliente_id, fase_numero, texto, descricao, ator, tipo, ordem)
  VALUES
    (p_cliente_id, 3, 'Nome do aplicativo definido', 'Como o app aparecerá nas lojas.', 'cliente', 'form', 1),
    (p_cliente_id, 3, 'Descrição curta preenchida (até 80 caracteres)', 'Frase de impacto para resultados de busca.', 'cliente', 'form', 2),
    (p_cliente_id, 3, 'Descrição completa preenchida', 'Descrição detalhada (até 4000 caracteres).', 'cliente', 'form', 3),
    (p_cliente_id, 3, 'URL de política de privacidade informada', 'Link para a página de privacidade.', 'cliente', 'form', 4),
    (p_cliente_id, 3, 'Formulário validado pelo analista', 'Analista revisa informações.', 'analista', 'check', 5),
    (p_cliente_id, 3, 'Build do aplicativo gerado', 'Dev gera o build.', 'analista', 'check', 6),
    (p_cliente_id, 3, 'App submetido para Google Play', 'Enviado para análise na Google Play.', 'analista', 'check', 7),
    (p_cliente_id, 3, 'App submetido para App Store', 'Enviado para análise na App Store.', 'analista', 'check', 8);
  ...
  VALUES
    ...
    (p_cliente_id, 5, 'Aprovei o app para publicação', 'Confirmo que o app está pronto.', 'cliente', 'approval', 3);
